...
public class LoadingScreen extends Screen {
	...
	public void update(float deltaTime) {
		...
		Assets.tail = g.newPixmap("pieRedBody.png", PixmapFormat.ARGB4444);
		Assets.body1 = g.newPixmap("pieRedBody.png", PixmapFormat.ARGB4444);
		Assets.body2 = g.newPixmap("pieGreenBody.png", PixmapFormat.ARGB4444);
		Assets.body3 = g.newPixmap("pieBlueBody.png", PixmapFormat.ARGB4444);
		Assets.stain1 = g.newPixmap("pie1.png", PixmapFormat.ARGB4444);
		Assets.stain2 = g.newPixmap("pie2.png", PixmapFormat.ARGB4444);
		Assets.stain3 = g.newPixmap("pie3.png", PixmapFormat.ARGB4444);
		Assets.headAnimRight = g.newPixmap("karlRightAnimColor.png", PixmapFormat.ARGB4444);
		Assets.click = game.getAudio().newSound("click.ogg");
		Assets.eat = game.getAudio().newSound("silaSchomp.ogg");
