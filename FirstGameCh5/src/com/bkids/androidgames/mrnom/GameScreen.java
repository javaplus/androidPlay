...
public class GameScreen extends Screen {
	...
	private void drawWorld(World world){
		...
		int x = stain.x * 32; // scale to make the world 32 by 32 squares
		int y = stain.y * 32;
		g.drawPixmap(stainPixmap, x, y);
		
		// draw the snake tail(s)... 
    ...
    private void drawRunningUI() {
        ...
        // draw the buttons pointing the right way
        // based on the direction of the snake
        Snake snake = world.snake;
        Pixmap leftButton = null;
        Pixmap rightButton = null;
        if(snake.direction == Snake.UP){
        	leftButton = Assets.buttonLeft;
        	rightButton = Assets.buttonRight;
        }else if(snake.direction == Snake.LEFT){
        	leftButton = Assets.buttonDown;
        	rightButton = Assets.buttonUp;
        }else if(snake.direction == Snake.DOWN){
        	leftButton = Assets.buttonRight;
			rightButton = Assets.buttonLeft;
        }else if(snake.direction == Snake.RIGHT){
        	leftButton = Assets.buttonUp;
			rightButton = Assets.buttonDown;
        }
        g.drawPixmap(leftButton, 0, 416);
    	g.drawPixmap(rightButton, 256, 416);
